...
/**
 * Builds the {@link JCodeModel} based on the given annotated elements. Those
...
public class ModelBuilder {
	 ...
	 *            The annotated elements to build the model for. Those elements
	 *            must be valid.
	 * @return the {@link JCodeModel} based on the given annotated elements.
	 * 
	 */
